		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <a href="tambahkonten.php" class="btn btn-md btn-primary">Tambah Konten</a>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php while($pecah=$ambil->fetch_assoc()){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="../foto_konten/<?php echo $pecah['foto']; ?>" width="100">	
                                    </td>
                                    <td>Deskripsi</td>
                                    <td>
                                        <a href="hapuskonten.php?id=<?php echo $pecah['id_produk']; ?>" class="btn-danger btn">Hapus</a>
                                        <a href="editkonten.php?id=<?php echo $pecah['id_produk'] ?>"class="btn-primary btn">Edit</a>
                                    </td>
                                </tr>
                                <?php $nomor++; ?>
								<?php } ?>
