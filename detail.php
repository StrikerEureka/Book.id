		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 order-lg-2 order-1">
					<div><img src="foto_konten/<?php echo $detail['foto'] ?>" alt="" style="width:380px;height:510px;"></div><br>
				</div>
				...
				<div class="col-lg-5 order-3">
					<div class="product_description">
						...
						<div class="product_text">Sinopsis :</div>
					<div>
					<p><?php echo "<p class='text-justify'>" . $detail['deskripsi'] . "</p>"; ?></p>
					<p><?php echo "<p class='text-justify'>" . $detail['deskripsi2'] . "</p>"; ?></p>
					</div><div class="product_price">Rp. <?php echo number_format($detail['harga']) ?>,-</div>
							<div class="order_info d-flex flex-row">
							<form method="post">
								
								<div class="form-group">
								<div class="input-group">
									<input type="number" min="1" class="form-control" name="jumlah" width="50px">
									<div class="input-group-btn">
									<button class="btn btn-primary" name="beli">Tambah ke keranjang</button>
								</div>
								</div>
								</div>
							</form>
